...
from module.plotting.vac_groups import plot_groups
...
fig = plot_groups(dr.vac[key], key, bounds = bounds_z, plot=True, hist_kwargs=hist_kwargs, ax_kwargs=ax_kwargs)
if SAVE_FIGS:
    savefigs(fig, f'ENSEMBLE-PROPERTIES-vac_bounds_{OBJ}_{key}', 'chap3')
